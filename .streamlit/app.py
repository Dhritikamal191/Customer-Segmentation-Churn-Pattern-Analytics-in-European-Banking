...
with tab2:
     ...
     - This suggests that {'high-value customers are at risk' if churned_balance > retained_balance else 'lower balance customers are more likely to churn'},which has direct implications on revenue and profitability.  
     """)
